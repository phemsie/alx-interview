#!/usr/bin/python3
"""method to check a data set represents a valid UTF-8 encoding"""
...
def validUTF8(data):
    ...
    for num in data:
        ...
        # Get the binary representation. We only need
        # the least significant 8 bits for any given number.
